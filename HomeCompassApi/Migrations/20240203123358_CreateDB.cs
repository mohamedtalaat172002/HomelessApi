    ...
    public partial class CreateDB : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FacilityResource", x => new { x.FacilitiesId, x.ResourcesId });
                    table.ForeignKey(
                        name: "FK_FacilityResource_Facilities_FacilitiesId",
                        column: x => x.FacilitiesId,
                        principalTable: "Facilities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FacilityResource_Resources_ResourcesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Facilities_ContributorId",
                table: "Facilities",
                column: "ContributorId");

            migrationBuilder.CreateIndex(
                name: "IX_FacilityResource_ResourcesId",
                table: "FacilityResource",
                column: "ResourcesId");

            migrationBuilder.CreateIndex(
                name: "IX_Homeless_ReporterId",
                table: "Homeless",
                column: "ReporterId");

            migrationBuilder.CreateIndex(
                name: "IX_Missings_ReporterId",
                table: "Missings",
                column: "ReporterId");
